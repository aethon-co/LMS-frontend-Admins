...
export const BatchCard: React.FC<BatchProps> = ({ batch }) => {
  return (
    <Link to={`/admin/batch/${batch._id}`} className="group block">
      <div className="bg-slate-800/50 border border-slate-700/50 backdrop-blur-sm rounded-2xl p-6 transition-all hover:bg-slate-800 hover:border-indigo-500/50 hover:shadow-[0_0_20px_rgba(79,70,229,0.15)] flex flex-col h-full">
